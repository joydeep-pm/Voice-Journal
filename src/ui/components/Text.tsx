...
const variantStyles: Record<TextVariant, TextStyle> = {
  display: {
    fontSize: typography.sizes[34] - 6,
    lineHeight: typography.sizes[34] - 2,
    fontWeight: typography.weights[700],
    color: color.text,
    letterSpacing: 0.12,
  },
  h1: {
    fontSize: typography.sizes[24] - 4,
    lineHeight: typography.sizes[24] + 2,
    fontWeight: typography.weights[700],
    color: color.text,
    letterSpacing: 0.1,
  },
  h2: {
    fontSize: typography.sizes[18] - 2,
    lineHeight: typography.sizes[18] + 2,
    fontWeight: typography.weights[600],
    color: color.text,
  },
  body: {
    fontSize: typography.sizes[16] - 2,
    lineHeight: typography.sizes[16] + 2,
    fontWeight: typography.weights[400],
    color: color.text,
  },
  caption: {
    fontSize: typography.sizes[13] - 2,
    lineHeight: typography.sizes[13] + 2,
